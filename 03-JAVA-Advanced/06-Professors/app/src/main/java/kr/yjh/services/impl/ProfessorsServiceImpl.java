...
public class ProfessorsServiceImpl implements ProfessorsService {
   ...
   private ProfessorsMapper professorsMapper;
    ...
    @Override
    public Professors addItem(Professors input) throws Exception {
    ...
    @Override
    public Professors editItem(Professors input) throws Exception {
    ...
    @Override
    public int deleteItem(Professors input) throws Exception {
    ...
    @Override
    public Professors getItem(Professors input) throws Exception {
    ...
    @Override
    public List<Professors> getList(Professors input) throws Exception {
        return professorsMapper.selectList(input);
    }

    @Override
    public int getCount(Professors input) throws Exception {
