...
public interface EnrollmentMapper {
    ...
    public int deleteItemByStudentId(Enrollment input);
     ...
     */
    @Select("SELECT student_id, subject_id, enroll_date, score FROM enrollments WHERE student_id=#{studentId} AND subject_id=#{subjectId}")
