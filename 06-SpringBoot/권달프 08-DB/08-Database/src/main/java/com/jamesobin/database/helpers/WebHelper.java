...
public class WebHelper {
     ...
     * @param name - 쿠키 이름
     * @param value - 쿠키 값
     * @param maxAge - 쿠키 유효시간 (0이면 지정 안함, 음수일 경우 즉시 삭제)
     * @param domain - 쿠키 도메인
     * @param path - 쿠키 경로
     */
     ...
     * @param maxAge - 쿠키 유효시간 (0이면 지정 안함, 음수일 경우 즉시 삭제)
     * 
     * @see #writeCookie(HttpServletResponse, String, String, int)
     */
    ...
    /**
     * 쿠키값을 저장한다. path 값을 "/"로, domain을 null로, maxAge를 0으로 강제 설정한다.
     * 
     * @param response - HttpServletResponse 객체
     * @param name - 쿠키 이름
     * @param value - 쿠키 값
     ...
     * 
     */
    public void writeCookie(String name) throws Exception {
    ...
    /**
     * HTTP 상태 코드를 200으로 설정하고 메시지를 출력 없이 지정된 페이지로 이동한다.
     * @param response     - HTTPServletResponse 객체
     * @param url          - 이동할 URL
     */
