...
public class HomeController {
    ...
    public String helloworld(Model model, HttpServletRequest request) {
        ...
        if (ip == null) {
            ...
            log.info(">>>> Proxy-Client-IP : " + ip);ku8
        }
        if (ip == null) {
        ...
        log.debug("browserFamily : " + c.os.family);
        log.debug("browserMajor : " + c.os.major);
        log.debug("browserMinor : " + c.os.minor);
