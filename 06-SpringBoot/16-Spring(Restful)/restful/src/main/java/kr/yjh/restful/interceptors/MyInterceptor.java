package kr.yjh.restful.interceptors;
...
import kr.yjh.restful.helpers.WebHelper;
...
public class MyInterceptor implements HandlerInterceptor {
     ...
     * return 값으로 boolean 값을 전달하는데 false 인경우
     ...
     */
     ...
     public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        Parser uaParser = new Parser();   // <-- 에러가 나는 이유는
        Client c = uaParser.parse(ua);    // <-- build.gradle 파일에
                                          // <-- dependencies{ ...여기... } 'com.github.ua-parser:uap-java:1.6.1' 추가
        ...
        log.info(clientInfo);   //에러여서 한동안 찾던거 : 원인 = clientInfo 라는 변수가 선언 된적이 없음
      ...
      * request 로 넘오온 데이터 가공 시 많이 사용된다. 
      */
      ...
      public void postHandle(HttpServletRequest request, HttpServletResponse response, Object handler,
        ...
        /**
         * 컨트롤러 종료 수 view가 정상적으로 랜더링 된 후 제일 마지막에 실행 되는 메서드. 
         * (잘 사용 안함)
         */
