...
/** ============================================================================================= */
    ...
    public void redirect(String url) {
      ...
      public void badRequest(Exception e) {
        log.error("[403] BadRequest Error ::: " + e.getMessage(), e);               ////////////////////   추가  06.16
      ...
      public void badRequest(String message) {
        log.error("[403] BadRequest Error ::: " + message);                        ////////////////////   추가  06.16
      ...
      public void serverError(Exception e) {
        ...
        log.error("[500] server Error ::: " + message, e);                         ////////////////////   추가  06.16
      ...
      public void serverError(String message) {
        log.error("[500] server Error ::: " + message);                               ////////////////////   추가  06.16
        this.redirect(500, null, message);
      }
    }
