function getValueError(msg = '잘못된 요청입니다.', selector = undefined) {
...
/**
 * 두 값이 동일한지 검사한다.
 * @param {string} origin      검사할 대상에 대한 <INPUT>요소의 selector
...
//■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■
/**
 * 라디오나 체크박스가 선택된 항목인지 확인한한다.
 * @param {string} selector  감시할 checkBox에 대한 selector
 * @param {string} msg       검사에 실패할 경우 표시할 메시지
 */
...
//■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■
/** 이메일 주소 형식인지 검사하기 위해 selector()를 간접적으로 호출한다.
 * @param {string} selector  검사할 대상에 대한 <INPUT>요소의 selector
 * @param {string} msg       표시할 메시지
 */
